        ...
        <form aria-label="Generate your course" onSubmit={e => e.preventDefault()} className="flex flex-col gap-6">
            ...
            <label className="flex flex-col gap-2 group">
                ...
                <input
                    ...
                    autoComplete="off"
                    className="font-input px-4 py-2 w-full bg-transparent border border-stroke-weak rounded-xs outline-none placeholder:text-stroke-strong focus:border-brand transition-colors duration-200"
                />
            </label>

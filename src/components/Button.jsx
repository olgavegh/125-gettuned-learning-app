...
export default function Button({
    ...
    return (
        <button
            ...
            disabled={disabled}
            onClick={onClick}
            className={`sans-regular inline-flex items-center gap-2 px-5 py-3 text-sm rounded-xs transition-colors duration-200 disabled:opacity-30 disabled:cursor-not-allowed ${variants[variant]} ${className}`}
        >
